...
# Завантаження даних
equipment_df = pd.read_csv('russia_losses_equipment.csv')  # обладнання
corrections_df = pd.read_csv('russia_losses_equipment_correction.csv')  # техніка
personnel_df = pd.read_csv('russia_losses_personnel.csv') # персональній состав
...
# Виконання перетворень даних (якщо потрібно)
